...
const ro = {
  ...
  "settings.eyebrow": "Organizație",
  "settings.title": "Setări",
  "settings.name": "Denumire",
  "settings.slug": "Identificator",
  "settings.created": "Creată la",
  "settings.stopHeading": "Oprește evaluările",
  "settings.stopExplanation":
    "Oprește imediat orice atingere a sistemelor instituției de către această platformă. O evaluare în curs se oprește și lasă dovezi parțiale. Nimic nu repornește până când cineva nu decide asta aici.",
  "settings.stopButton": "Oprește tot",
  "settings.stopReason": "Oprit din pagina de setări",
  "settings.stopped": "oprit",
  "settings.stoppedSince": "Activ din {when}",
  "settings.resumeButton": "Reia evaluările",
  "settings.resumeReason": "Reluat din pagina de setări",
  "settings.stopped2": "Evaluările au fost oprite.",
  "settings.resumed": "Evaluările pot rula din nou.",
  "settings.stopFailed": "Oprirea nu a putut fi înregistrată.",
  "settings.resumeFailed": "Reluarea nu a putut fi înregistrată.",
  "settings.elsewhereHeading": "Ce se configurează în altă parte",
  "settings.elsewhere":
    "Cadența evaluărilor se stabilește pe fiecare domeniu, pentru că domenii diferite se schimbă în ritmuri diferite. Metodologia și perioadele de păstrare sunt aceleași pentru toată lumea: dacă ar fi reglabile per instituție, două scoruri nu ar mai putea fi comparate.",
...
const en: Messages = {
  ...
  "settings.eyebrow": "Organisation",
  "settings.title": "Settings",
  "settings.name": "Name",
  "settings.slug": "Identifier",
  "settings.created": "Created",
  "settings.stopHeading": "Stop assessments",
  "settings.stopExplanation":
    "Immediately stops this platform touching the institution's systems. An assessment in flight halts and leaves partial evidence. Nothing resumes until somebody decides so here.",
  "settings.stopButton": "Stop everything",
  "settings.stopReason": "Stopped from the settings page",
  "settings.stopped": "stopped",
  "settings.stoppedSince": "In force since {when}",
  "settings.resumeButton": "Resume assessments",
  "settings.resumeReason": "Resumed from the settings page",
  "settings.stopped2": "Assessments are stopped.",
  "settings.resumed": "Assessments can run again.",
  "settings.stopFailed": "The stop could not be recorded.",
  "settings.resumeFailed": "The resume could not be recorded.",
  "settings.elsewhereHeading": "What is configured elsewhere",
  "settings.elsewhere":
    "Assessment cadence is set per domain, because different domains change at different rates. The methodology and the retention periods are the same for everybody: made adjustable per institution, two scores would stop being comparable.",
